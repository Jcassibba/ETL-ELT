# this program ELT program will read and generate "Tier 1" csv from benchmark data
...
print(tier_1_df) #check


#####################write needs_Testing_df to csv

needs_testing = open("Tier_1.csv","w")
needs_testing.write(tier_1_df)
needs_testing.close
