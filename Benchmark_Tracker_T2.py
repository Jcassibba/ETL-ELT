# this program ELT program will read and generate "Tier 2" csv from benchmark data
...
print(tier_2_df) #check


#####################write needs_Testing_df to csv

needs_testing = open("Tier_2.csv","w")
needs_testing.write(tier_2_df)
needs_testing.close
